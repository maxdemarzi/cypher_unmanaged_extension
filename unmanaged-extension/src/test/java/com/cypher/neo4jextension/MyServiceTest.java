...
public class MyServiceTest {
    ...
    public void shouldGetFriends() throws IOException {
        ...
        assertEquals(new HashSet<String>(Arrays.asList("B","E","F")), new HashSet<String>(list));
    }

    @Test
    public void shouldGetFofs() throws IOException {
        Response response = service.getFofs("A", db);
        List actual = objectMapper.readValue((String) response.getEntity(), List.class);
        List<HashMap<String, Object>> expected = Arrays.asList(entryOne, entryTwo);
